...
class KerasModel:
    def __init__(self):
        ...
        self.preprocessing_layer = keras.models.load_model('./Models_ManyTitles/preprocessing_layer')

        # Load encoder model
        self.encoder_model = keras.models.load_model('./Models_ManyTitles/encoder_model')
